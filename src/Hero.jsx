      ...
      <NewspaperBackground>
        ...
        <div className="max-w-5xl mx-auto px-4 pb-12 pt-4">
          <div className="border-t-2 border-amber-900/40 pt-4 flex justify-between items-center">
            ...
            <span className="font-bigshot text-xs text-amber-600 tracking-widest">EST. 2025</span>
          </div>
        </div>
      </NewspaperBackground>
...
const PROJECTS = [
  {
    ...
    tag: "Peer Reviewed · Figma -> Code · Responsive Design",
  ...
  },
  {
    ...
    tag: "Parallax Scrolling · Accessible Carousel · Responsive",
  ...
  },
  {
    ...
    tag: "Design Thinking · Bootstrap · Collaborative",
  ...
  },
  {
    ...
    deck: "A mock music player website dedicated towards exploring backend code with a focus on performance, scalability, and developer experience.",
    tag: "Web Dev · Performance · Trending Music · APIs",
  ...
  },
  {
    ...
    deck: "An immersive web-based game that uses branching narratives and interactive storytelling to explore the consequences of user decisions in a simulated world.",
    tag: "Interactive Storytelling · Branching Narratives · Vanilla",
